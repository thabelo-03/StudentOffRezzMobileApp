...
- To use the deployed backend on Render, set `EXPO_PUBLIC_API_BASE_URL=https://studentoffrezzmobileapp.onrender.com`
- To test backend changes from a real phone on the same Wi-Fi, set `EXPO_PUBLIC_API_BASE_URL=http://YOUR_COMPUTER_LAN_IP:5000`
...
3. Set `EXPO_PUBLIC_API_BASE_URL=http://192.168.1.239:5000`
